                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <table class="table table-centered table-nowrap mb-0">
                                            <thead>
                                              <tr>
                                                ...
                                                <th scope="col">Show Province</th>
                                                <th scope="col">Add Province</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <a href="{{ route('admin.province.show', ['id' => $item->id]) }}" class="px-2    btn btn-primary">Show Province</a>
                                                        {{-- {{ route('admin.jobs.edit', ['id' => $item->id]) }} --}}
                                                   </td>
                                                    <td><a href="{{ route('admin.add_province', ['id' => $item->id]) }}" class="px-2    btn btn-primary">Add Province</a></td>
                                                    <td>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-6">
                                            <div>
                                                <p class="mb-sm-0">Showing {{ $lottery->firstItem() }} to {{ $lottery->lastItem() }} of {{ $lottery->total() }} entries</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
