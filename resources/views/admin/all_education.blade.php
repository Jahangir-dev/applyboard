                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Education List</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <table class="table table-centered table-nowrap mb-0">
                                            <thead>
                                              <tr>
                                                ...
                                                <th scope="col">Education Grade</th>
                                                <th scope="col">Show Levels</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <a href="{{ route('admin.level.show', ['id' => $item->id]) }}" class="px-2    btn btn-primary">Show Level</a>
                                                        {{-- {{ route('admin.jobs.edit', ['id' => $item->id]) }} --}}
                                                   </td>
                                                    <td><a href="{{ route('admin.add_level', ['id' => $item->id]) }}" class="px-2    btn btn-primary">Add Level</a></td>
                                                    <td>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-6">
                                            <div>
                                                <p class="mb-sm-0">Showing {{ $Education->firstItem() }} to {{ $Education->lastItem() }} of {{ $Education->total() }} entries</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
