                                        ...
                                        <table class="table table-centered table-nowrap mb-0">
                                            <thead>
                                              <tr>
                                                ...
                                                <th scope="col">Edit Province</th>
                                                <th scope="col">Delete Province</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td> 
                                                        ...
                                                        <a href="" class="px-2    btn btn-primary">Edit Province</a>
                                                        {{-- {{ route('admin.jobs.edit', ['id' => $item->id]) }} --}}
                                                   </td>
                                                    <td><a href="" class="px-2    btn btn-danger">Delete Province</a></td>
                                                    <td>
