    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    <a href="{{route('partner.partner_home')}}" target="_self">
                ...
                <li>
                    <a href="{{route('partner.students')}}" class=" waves-effect"  target="_self">
                ...
                <li>
                    <a href="{{route('partner.payment')}}" class=" waves-effect" href=""  target="_self">
