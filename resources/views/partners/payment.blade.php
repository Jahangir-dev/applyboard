                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1 align-self-center">
                                                    <div class="border-bottom pb-1">
                                                        <h5 class="text-truncate font-size-16 mb-1"><a href="#" class="text-dark">USA</a></h5>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1 align-self-center">
                                                    <div class="border-bottom pb-1">
                                                        <h5 class="text-truncate font-size-16 mb-1"><a href="#" class="text-dark">CAD</a></h5>
                                                        <p class="text-muted">
                                                             Canadian Doller
                                                             <h6>$0.00</h6>
                                                        </p>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 align-self-center">
                                                        <div class="border-bottom pb-1">
                                                            <h5 class="text-truncate font-size-16 mb-1"><a href="#" class="text-dark">GBP</a></h5>
                                                            <p class="text-muted">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 align-self-center">
                                                        <div class="border-bottom pb-1">
                                                            <h5 class="text-truncate font-size-16 mb-1"><a href="#" class="text-dark"> AUD</a></h5>
                                                            <p class="text-muted">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="flex-grow-1 align-self-center">
                                                        <div class="border-bottom pb-1">
                                                            <h5 class="text-truncate font-size-16 mb-1"><a href="#" class="text-dark"> EUR</a></h5>
                                                            <p class="text-muted">
